...
class TestTarScenario01Task08(TpcpTestCase):
    ...
    # Test_08 tar --update -f test.tar [FILE]
            
    def scenario01_task08(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            os.chdir(directory)
            subprocess.run(["./"+self.exe,"--update -f test.tar","file1.txt","file2.txt"])
