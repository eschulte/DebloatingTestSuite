...
class TestTarScenario01Task10(TpcpTestCase):
    ...
    # Test_10 tar --compare --file=test.tar [FILE] $ tar --diff --file=test.tar [FILE]
            
    def scenario01_task10(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            os.chdir(directory)
            subprocess.run(["./"+self.exe,"--compare","--file=test.tar [FILE]","--diff","--file=test.tar [FILE]"])
