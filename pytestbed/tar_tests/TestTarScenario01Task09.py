...
class TestTarScenario01Task09(TpcpTestCase):
    ...
    # Test_09  tar --concatenate --file=test.tar [FILE]	
            
    def scenario01_task09(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            os.chdir(directory)
            subprocess.run(["./"+self.exe,"--concatenate","--file=test.tar [FILE]"])
